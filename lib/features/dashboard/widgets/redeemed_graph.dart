...
class RedeemedGraph extends ConsumerWidget {
  const RedeemedGraph({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final redeemAsync = ref.watch(redeemChartProvider);

    return CustomContainer(
      height: 210,
      child: Padding(
        padding: const EdgeInsets.all(16.0),
        child: redeemAsync.when(
          data: (points) {
            if (points.isEmpty) {
                ...
                Expanded(
                  child: BarChart(
                    BarChartData(
                      ...
                      barGroups: _chartGroups(points: points, color: blue),
